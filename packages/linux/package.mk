...
PKG_STAMP="${DEVICE:-$PROJECT} $KERNEL_TARGET $KERNEL_MAKE_EXTRACMD $KERNEL_UBOOT_EXTRA_TARGET"
...
case "$LINUX" in
  amlogic-3.10)
    ...
    ;;
  amlogic-3.14)
    PKG_VERSION="2438edf7b74c5ce9ec4b44653928cb2cbf53c70c"
    # PKG_SHA256="0b5f0ecffe6ceb0e31dfc6c27ba328d0682b05723fe88a2f5c4cf6ceb7b7565f"
    PKG_URL="https://github.com/Owersun/linux-libre/archive/$PKG_VERSION.tar.gz"
    PKG_SOURCE_DIR="$PKG_NAME-libre-$PKG_VERSION*"
